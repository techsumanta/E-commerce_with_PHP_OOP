        ...
        <form id="createProduct" class="add-post-form row" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="file" class="product_image" name="featured_img" requried />
                    <img id="image" src="" width="150px"/>
                </div>
                <div class="form-group">
                    <label for="">Product Price</label>
                    <input type="text" class="form-control product_price" name="product_price" value="" requried />
                </div>
                <div class="form-group">
                    <label for="">Available Quantity</label>
                    <input type="number" class="form-control product_qty" name="product_qty" value="" requried />
                </div>
                <div class="form-group">
                    <label>Status</label>
