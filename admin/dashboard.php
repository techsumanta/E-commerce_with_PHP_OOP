...
<div class="admin-content-container">
        ...
        <div class="row">
            <div class="col-md-12">
                <?php
                    $db = new Database();
                    $db->select('product_master','product_id',null,'product_stock_qty < 1',null,0);
                    $qty = $db->getResult();
                    if(!empty($qty)){  ?>
            ...
            <!-- <div class="col-md-4">
                <?php
                    $db = new Database();
                    $db->select('product_master','COUNT(product_id) as p_count',null,null,null,0);
            ...
            <!-- <div class="col-md-4">
                <div class="detail-box">
                    <?php
                        $db = new Database();
                        $db->select('brand','COUNT(brand_id) as b_count',null,null,null,0);
                        $brands = $db->getResult();
                    ?>
