...
$db = new Database();
$db->select('site_info','site_name,site_logo,currency_format');
$result = $db->getResult();

    $cur_format = 'Rs.';
    if(!empty($result[0]['currency_format'])){
        $cur_format = $result[0]['currency_format'];
    }
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-3" id="admin-menu">
                         <ul class="menu-list">
                            ...
                            <li <?php if(basename($_SERVER['PHP_SELF']) == "comp_info.php") echo 'class="active"'; ?>><a href="comp_info.php">Company Info</a></li>
                        </ul>
                    </div>
                    <!-- Menu Bar End -->
                    <!-- Content Start -->
