                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if($row['user_status'] == '1'){ ?>
                                <a href="" class="btn btn-xs btn-primary user-status" data-id="<?php echo $row['user_id']; ?>" data-status="<?php echo $row['user_status'] ?>">Block</a>
                            <?php }else{ ?>
                                <a href="" class="btn btn-xs btn-primary user-status" data-id="<?php echo $row['user_id']; ?>" data-status="<?php echo $row['user_status'] ?>">Unblock</a>
                            <?php   } ?>
                            <!-- <a class="btn btn-xs btn-danger delete_user" href="javascript:void(0);" data-id=""><i class="fa fa-trash"></i></a> -->
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
