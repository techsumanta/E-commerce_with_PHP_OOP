            ...
            <div class="col-md-12 clearfix">
                ...
                <?php
                    if(isset($_COOKIE['user_cart'])){
                        ...
                        $pids = implode(',',$pid);                        
                        $db = new Database();
                        $db->select('product_master','*',null,'product_id IN ('.$pids.')',null,null);
                        $result = $db->getResult();
                        if(count($result) > 0){ ?>
                                ...
                                <?php foreach($result as $row){ ?>
                                    <tr class="item-row">
                                        <td><img src="product-images/<?php echo $row['product_image']; ?>" alt="" width="70px" /></td>
                        ...
                        <?php    } ?>
                                ...
                                <form action="delivery_details.php" class="checkout-form pull-right" method="POST">
                                    <?php
                                        $product_id = '';                                        
                                    ...
                                    <input type="submit" class="btn btn-md btn-success checkout" value="Proceed to Checkout">
                                </form>
                                <?php }else{ ?>
