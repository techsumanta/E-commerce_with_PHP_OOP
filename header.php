<?php 
    $db = new Database();
    $db->select('site_info','site_name,site_title,site_logo,currency_format');
    $header = $db->getResult();
...
<head>
    ...
    <?php if(!empty($header[0]['site_title'])){ ?>
        <title><?php echo $header[0]['site_title']; ?></title>
    <?php }else{ ?>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <?php                
                    if(!empty($header[0]['site_logo'])){ ?>
                        <a href="<?php echo $hostname; ?>" class="logo-img"><img src="images/<?php echo $header[0]['site_logo']; ?>" alt="" style="width:170px;height:100px;"></a>
                    <?php }else{ ?>
            ...
            <div class="col-md-7">
                ...
                <div class="input-group search">
                    <input type="text" class="form-control" name="search" placeholder="Search by Sub Category like saree...">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <?php
                                if(isset($_SESSION["user_role"])){ ?>
                                    ...
                                    <li><a href="javascript:void(0)" class="user_logout" >Logout</a></li>
                            <?php  }else{ ?>
                        ...
                        foreach($result as $res){ ?>                            
                            <li>
                                <div class="dropdown">
                                    ...
                                    <?php
                                        $db = new Database();
                                        $db->select('sub_categories','*',null,"cat_parent_id = '{$res['cat_id']}' AND sub_cat_status = '1'",null,null);
                                        ...
                                        if(count($sub_cat) > 0) {
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                foreach($sub_cat as $subcat) {
                                                    ?>
                                                    <li><a class="dropdown-item" href="product_by_subcat.php?subcat_id=<?php echo $subcat['sub_cat_id']; ?>&subcat_title=<?php echo $subcat['sub_cat_title']; ?>" style="color:black;"><?php echo $subcat['sub_cat_title']; ?></a></li>
                                                    <?php
                                                }
                                                ?>
                                            </ul>
