...
// $res = $db->getResult();
$db->select('product_master','*',null,"product_id= '{$p_id}'",null,null);
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-5 col-md-7">
                <?php
                $db = new Database();
                $db->select('sub_categories','*',null,"sub_cat_id='{$single_product[0]['product_subcat_id']}'",null,null);
                $sub_cat_result = $db->getResult();
                ?>
                <ol class="breadcrumb">
                    <li><a href="<?php echo $hostname; ?>">Home</a></li>
                    <li><a href="product_by_subcat.php?subcat_id=<?php echo $sub_cat_result[0]['sub_cat_id']; ?>&subcat_title=<?php echo $sub_cat_result[0]['sub_cat_title']; ?>"><?php echo $sub_cat_result[0]['sub_cat_title']; ?></a></li>
        ...
        <?php foreach($single_product as $row){ ?>
                ...
                <div class="col-md-2">
                    <div class="product-image">
                        <img id="product-img" src="product-images/<?php echo $row['product_image'] ?>" alt=""/>
                    </div>
                </div>
